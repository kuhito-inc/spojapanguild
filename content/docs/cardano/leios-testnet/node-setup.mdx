...
do you want to allow configuration setting 'extra-substituters' to be set to 'https://cache.iog.io https://tweag-jupyter.cachix.org' (y/N)? 
do you want to permanently mark this value as trusted (y/N)?
do you want to allow configuration setting 'extra-trusted-public-keys' to be set to 'hydra.iohk.io:f/Ea+s+dFdN+3Y/G+FDgSq+a5NEWhJGzdjvKNGv0/EQ= tweag-jupyter.cachix.org-1:UtNH4Zs6hVUFpFBTLaA4ejYavPo5EFFqgd7G7FxGW9g=' (y/N)? 
do you want to permanently mark this value as trusted (y/N)?
...
ファイルをダウンロードします。
```bash
wget --no-use-server-timestamps -q https://spojapanguild.net/node_config/11.0.1/${NODE_CONFIG}-byron-genesis.json -O ${NODE_CONFIG}-byron-genesis.json
wget --no-use-server-timestamps -q https://spojapanguild.net/node_config/11.0.1/${NODE_CONFIG}-shelley-genesis.json -O ${NODE_CONFIG}-shelley-genesis.json
wget --no-use-server-timestamps -q https://spojapanguild.net/node_config/11.0.1/${NODE_CONFIG}-alonzo-genesis.json -O ${NODE_CONFIG}-alonzo-genesis.json
wget --no-use-server-timestamps -q https://spojapanguild.net/node_config/11.0.1/${NODE_CONFIG}-conway-genesis.json -O ${NODE_CONFIG}-conway-genesis.json
wget --no-use-server-timestamps -q https://spojapanguild.net/node_config/11.0.1/${NODE_CONFIG}-config.json -O ${NODE_CONFIG}-config.json
wget --no-use-server-timestamps -q https://spojapanguild.net/node_config/11.0.1/${NODE_CONFIG}-topology.json -O ${NODE_CONFIG}-topology.json
wget --no-use-server-timestamps -q https://spojapanguild.net/node_config/11.0.1/${NODE_CONFIG}-checkpoints.json -O ${NODE_CONFIG}-checkpoints.json
```
...
## 8. エアギャップのセットアップ [#sec-13]

### cardano-cli バイナリをコピー [#sec-14]
