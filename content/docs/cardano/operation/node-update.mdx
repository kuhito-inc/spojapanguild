...
| :----------: | :----------: | :----------: | :----------: | :----------: | :----------: |
| ubuntu 24.04.* | 11.1.2 | 11.2.3.0 | 9.6.7 | 3.12.1.0 | 6.7.0 |
...
wget https://github.com/IntersectMBO/cardano-node/releases/download/11.1.2/cardano-node-11.1.2-linux-amd64.tar.gz
```
...
配布リポジトリが変更されたため、既存の自動更新では最新版を取得できません。新しいURLから再取得してください。

```bash
cd $NODE_HOME/scripts
wget https://raw.githubusercontent.com/kuhito-inc/sjg-tools/main/sjgtool.sh -O sjgtool.sh
...
## 5. Grafana Dashboard設定 [#sec-23]

### Dashboardのインポート [#sec-24]
