...
### 1-1. BPにMithril Signerのインストール [#sec-2]
...
### 1-2. Mithrilリレーノードのセットアップ [#sec-5]
...
### 1-5. Grafanaダッシュボード設定 [#sec-9]

<Tabs items={["ブロックプロデューサー", "Grafana導入サーバー"]}>
<Tab value="ブロックプロデューサー">
...
### 2-1. BPのMithril Signer更新 [#sec-11]
...
### 2-2. リレーノードのMithril Signer更新 [#sec-12]
