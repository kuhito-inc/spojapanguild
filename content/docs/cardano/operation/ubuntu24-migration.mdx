...
### 1-3. SSHターミナルバージョン最新化 [#sec-4]

WindowsでR-loginをご利用の場合は、[最新のRLogin](https://github.com/kmiya-culti/RLogin/releases/)を使用して下さい。

### 1-4. 作業対象サーバログイン [#sec-5]

<Callout type="info" title="接続方法">

[1-4. 作業対象サーバログイン](/docs/cardano/operation/ubuntu24-migration#sec-5)〜[1-9. Ubuntuバージョン確認](/docs/cardano/operation/ubuntu24-migration#sec-10)は通常のSSH接続で作業してください。
...
### 1-7. システムアップデート [#sec-8]
```bash
sudo apt update && sudo apt full-upgrade -y && sudo apt autoremove -y
```

### 1-8. LTSアップグレード設定の確認 [#sec-9]
```bash
grep Prompt /etc/update-manager/release-upgrades
```
> Prompt=lts であること

### 1-9. Ubuntuバージョン確認 [#sec-10]
...
### 1-10. リレーサーバーにGrafanaを搭載している場合の対応 [#sec-11]
...
[3. アップグレード確認(SSH接続)](/docs/cardano/operation/ubuntu24-migration#sec-16)〜[5. sysctlの設定](/docs/cardano/operation/ubuntu24-migration#sec-22)はSSH接続で作業してください。

</Callout>


### 3-1. 現在のUbuntuバージョン確認 [#sec-17]
...
### 3-4. リレーサーバーにGrafanaを搭載している場合の対応 [#sec-20]
...
現在の最新バージョンはv2.5.*なのでそれ以下の方は、[4. アップデート手順](/docs/cardano/setup/blocknotify-setup#sec-4)を実施して更新してください。
...
[1. 依存環境アップデート](/docs/cardano/operation/node-update#sec-1) ~ [3. 依存関係作業](/docs/cardano/operation/node-update#sec-11)  
