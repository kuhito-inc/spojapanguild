...
[ノードアップデート手順](/cardano/operation/node-update)の[1. 依存環境アップデート](/cardano/operation/node-update#sec-1)から[5. Grafana Dashboard設定](/cardano/operation/node-update#sec-22)まで、各章の対象条件に従って実施してください。Tracer設定に加え、関連ツール・サービスとGrafanaの更新も確認します。

エアギャップの`cardano-cli`も更新する場合は、[6. エアギャップアップデート](/cardano/operation/node-update#sec-25)も実施してください。
