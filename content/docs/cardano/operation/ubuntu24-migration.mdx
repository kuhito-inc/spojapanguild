...
[1-4. 作業対象サーバログイン](/docs/cardano/operation/ubuntu24-migration#1-4-作業対象サーバログイン)〜[1-9. Ubuntuバージョン確認](/docs/cardano/operation/ubuntu24-migration#1-9-ubuntuバージョン確認)は通常のSSH接続で作業してください。
...
[3. アップグレード確認(SSH接続)](/docs/cardano/operation/ubuntu24-migration#3-アップグレード確認ssh接続)〜[5. sysctlの設定](/docs/cardano/operation/ubuntu24-migration#5-sysctlの設定)はSSH接続で作業してください。
...
現在の最新バージョンはv2.5.*なのでそれ以下の方は、[4. アップデート手順](/docs/cardano/setup/blocknotify-setup#4-アップデート手順)を実施して更新してください。
...
[1. 依存環境アップデート](/docs/cardano/operation/node-update#1-依存環境アップデート) ~ [3. 依存関係作業](/docs/cardano/operation/node-update#3-依存関係作業)  
