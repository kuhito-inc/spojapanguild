...
新サーバーで[Ubuntu初期設定](../../setup/ubuntu-setup)を実施します。  


### **1-2. ノードセットアップ**

1. [1. 依存関係インストール](../setup/node-setup.md/#1) 〜 [7. gLiveViewのインストール](../setup/node-setup.md/#7-gliveview)まで実施します。
...
- [ブロックログ設定](../../setup/blocklog-setup)


### **4-6. SJGツール導入**

- [SJGツール導入設定](../../operation/sjg-tool-setup)
...
1. 新BPで[1. 依存プログラムのインストール](../setup/blocknotify-setup.md/#1)のみを実施
2. 旧BPで設定ファイルを確認
...
3. 新BPで[3. 通知プログラムの設定](../setup/blocknotify-setup.md/#3)を実施します。
...
[SPO BlockNotify設定](../../setup/blocknotify-setup)から導入してください。
