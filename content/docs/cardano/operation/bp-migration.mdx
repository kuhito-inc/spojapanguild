...
- 旧BPは[6-1. 旧BPシャットダウン](/docs/cardano/operation/bp-migration#sec-21)まで、**起動状態** にしておいてください。
...
2. [2. トポロジーファイル設定変更](/docs/cardano/setup/relay-bp-setup#sec-5)の`BP`の手順を実施します。
