...
<Callout type="error" title="既知の不具合">


なし

その他バグを発見した場合はGithubで[issue](https://github.com/btbf/spojapanguild/issues)を提出してください。
...
### v4.1.2
    * SPOガバナンスアクション投票のバグを修正

### v4.1.1
    * ガバナンスアクション投票のバグを修正

### v4.1.0
    * 投票可能なガバナンスアクションの自動表示
    * 代替IPFSゲートウェイの追加
    * SPO投票理由メタデータ（任意のURLとBlockfrost-IPFS）を追加しました

### v4.0.4
    * ブロック生成状態チェックにnode.certプールIDチェックを導入
