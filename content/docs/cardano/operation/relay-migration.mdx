...
2. [2. トポロジーファイル設定変更](/docs/cardano/setup/relay-bp-setup#2)の「**`リレーノードの場合`**」を実施します。
...
[監視ツール設定](/docs/cardano/setup/monitoring-setup)のリレーノード1タブと[3. Grafanaダッシュボードの設定](/docs/cardano/setup/monitoring-setup#3-grafana)を実行する。
