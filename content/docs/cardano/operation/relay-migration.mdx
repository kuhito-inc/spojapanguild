...
[7. gLiveViewのインストール](/cardano/setup/node-setup#sec-12)まで実施します。
...
[監視ツール設定](/cardano/setup/monitoring-setup)のリレー1タブと[3. Grafanaダッシュボードの設定](/cardano/setup/monitoring-setup#sec-4)を実行する。
