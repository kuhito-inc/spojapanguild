...
### ノードセットアップ [#sec-3]
1. [1. 依存関係インストール](/docs/cardano/setup/node-setup#sec-1) 〜
[7. gLiveViewのインストール](/docs/cardano/setup/node-setup#sec-12)まで実施します。
2. [2. トポロジーファイル設定変更](/docs/cardano/setup/relay-bp-setup#sec-5)のリレーの手順を実施します。
...
[監視ツール設定](/docs/cardano/setup/monitoring-setup)のリレー1タブと[3. Grafanaダッシュボードの設定](/docs/cardano/setup/monitoring-setup#sec-4)を実行する。
