...
| :----------: | :----------: | :----------: | :----------: | :----------: |
| 11.1.1 | 11.2.3.0 | 9.6.7 | 3.12.1.0 | 6.7.0 |
...
git rev c2ebdc87dfe07706a83e52f219e712c60d1b0a56  
...
ファイルをダウンロードします。
```bash
wget --no-use-server-timestamps https://spojapanguild.net/node_config/11.1.1/${NODE_CONFIG}-byron-genesis.json -O ${NODE_CONFIG}-byron-genesis.json
wget --no-use-server-timestamps https://spojapanguild.net/node_config/11.1.1/${NODE_CONFIG}-shelley-genesis.json -O ${NODE_CONFIG}-shelley-genesis.json
wget --no-use-server-timestamps https://spojapanguild.net/node_config/11.1.1/${NODE_CONFIG}-alonzo-genesis.json -O ${NODE_CONFIG}-alonzo-genesis.json
wget --no-use-server-timestamps https://spojapanguild.net/node_config/11.1.1/${NODE_CONFIG}-conway-genesis.json -O ${NODE_CONFIG}-conway-genesis.json
wget --no-use-server-timestamps https://spojapanguild.net/node_config/11.1.1/${NODE_CONFIG}-config.json -O ${NODE_CONFIG}-config.json
wget --no-use-server-timestamps https://spojapanguild.net/node_config/11.1.1/${NODE_CONFIG}-topology.json -O ${NODE_CONFIG}-topology.json
wget --no-use-server-timestamps https://spojapanguild.net/node_config/11.1.1/${NODE_CONFIG}-checkpoints.json -O ${NODE_CONFIG}-checkpoints.json
```
...
```bash
wget --no-use-server-timestamps https://spojapanguild.net/node_config/11.1.1/${NODE_CONFIG}-peer-snapshot.json -O ${NODE_CONFIG}-peer-snapshot.json
```
...
```bash
wget --no-use-server-timestamps https://spojapanguild.net/node_config/11.1.1/${NODE_CONFIG}-tracer-config.json -O ${NODE_CONFIG}-tracer-config.json
```
