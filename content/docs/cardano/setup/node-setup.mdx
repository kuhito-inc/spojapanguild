...
### 1-2. Secp256k1ライブラリインストール [#sec-3]
...
手順はこちら→[DB同期(Mithril)](/docs/cardano/operation/mithril-client)
...
### 8-1. `cardano-cli`バイナリのコピー [#sec-14]
リレーサーバーで[バイナリファイルのコピー](/docs/cardano/operation/node-update#4)をします。
