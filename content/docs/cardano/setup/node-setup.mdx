...
**短縮する場合：** [Mithril による DB 同期](/docs/cardano/operation/mithril-client) で、初回を **目安30分以内** にできます。
...
リレーサーバーで[バイナリファイルをコピー](/docs/cardano/operation/node-update#sec-15)を実施します。
