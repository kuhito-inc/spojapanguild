...
- [1. Ubuntu Desktopイメージの取得](/docs/cardano/setup/air-gapped-setup#1-ubuntu-desktopイメージの取得)で取得したISOイメージファイル
...
[バイナリーファイルコピー](/docs/cardano/operation/node-update#4-エアギャップアップデート)を参照してください。
