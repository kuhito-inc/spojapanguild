...
- [1. Ubuntu Desktopイメージの取得](/docs/cardano/setup/air-gapped-setup#1-ubuntu-desktop)で取得したISOイメージファイル
...
[バイナリーファイルコピー](/docs/cardano/operation/node-update#4)を参照してください。
