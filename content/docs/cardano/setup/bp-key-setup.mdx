...
<mark>外部に流出するとプールが乗っ取られる可能性がありますので管理には十分注意してください</mark>  
また複数のUSBに保管し、絶対に上書き・削除しないようご注意下さい。  
...
あなたのBPノードが完全に同期されたことを確認するには、[Cardano Explorer](https://explorer.cardano.org/ja.html)で自身の同期済みエポックとスロットが一致しているかをご確認ください。
