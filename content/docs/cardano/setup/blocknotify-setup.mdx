...
* ブロックログと連動しておりますので、まだ設定されてない場合は[ブロックログ設定](/cardano/setup/blocklog-setup)を先に導入してください。
...
| バージョン | 更新内容 |
| --- | --- |
| 2.6.0 | cardano-tracer対応、ブロック確認URLをCardanoScanへ変更、missed通知バグの修正
...
wget -4 https://github.com/btbf/block-notify/archive/refs/tags/${bn_release}.tar.gz -P $NODE_HOME/scripts
