...
本マニュアルを実施する前に、**エアギャップ環境構築**と**Cardano Preview ネットワーク**において、
Cardano ステークプールの構築からブロック生成までの一連の作業を完了していることを前提とします。

- [エアギャップ環境構築](/docs/cardano/setup/air-gapped-setup)
- [カルダノステークプール構築ガイド](/docs/cardano/setup)
...
| **リレー** | cardano-node | ≥4 vCPU | ≥8 GB | ≥100 GB SSD |  |
...
| **リレー-1** | cardano-node | ≥4 vCPU | 32 GB | 350 GB SSD |  |
| **リレー-2** | cardano-node | ≥4 vCPU | 32 GB | 350 GB SSD | 冗長用 |
